...
export default function IPBansPage() {
  ...
  const getBanActions = (ban: IPBan) => [
    { label: 'Unban', onClick: () => setDeleteModal({ ban, loading: false }), variant: 'danger' as const },
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-xl bg-neutral-800/30">
          ...
          <div className="bg-neutral-900/40 rounded-lg p-1">
            <Table columns={columns} data={bans} keyField="id" loading={loading} emptyText="No IP bans" contextMenu={getBanActions} />
          </div>
        </div>
      </div>
