...
import { notify, Button, Input, Pagination, Icons, ContextMenu, DatePicker, Table } from '../../../components';
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1">
            ...
            <ContextMenu
              ...
              items={[
                { label: 'All Logs', onClick: () => handleFilterChange('all') },
                { label: 'Admin Actions', onClick: () => handleFilterChange('admin') },
                { label: 'User Actions', onClick: () => handleFilterChange('user') },
              ]}
            />
          </div>
