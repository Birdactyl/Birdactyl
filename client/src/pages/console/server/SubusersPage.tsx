...
import { notify, Button, Icons, Table, Checkbox, PermissionDenied, FloatingBar } from '../../../components';
...
export default function SubusersPage() {
  ...
  const getSubuserActions = (sub: Subuser) => [
    { label: 'Edit Permissions', onClick: () => toggleExpand(sub.id) },
    { label: 'Remove', onClick: () => setRemoveSubuser(sub), variant: 'danger' as const },
  ];
