...
import { Button, Icons, Table, PermissionDenied, CreateDatabaseModal, DeleteDatabaseModal, ContextMenu } from '../../../components';
...
export default function DatabasesPage() {
  ...
  const getDbActions = (db: ServerDatabase) => [
    ...(can('database.update') ? [{ label: 'Rotate Password', onClick: () => handleRotate(db) }] : []),
    ...(can('database.delete') ? [{ label: 'Delete', onClick: () => setDeleteModal(db), variant: 'danger' as const }] : []),
  ];
