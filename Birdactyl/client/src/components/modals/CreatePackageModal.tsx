...
import { Input, Wizard, ContextMenu, Icons, Button, Checkbox } from '../';
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                ...
                <ContextMenu
                  ...
                  items={[
                    { label: 'SIGTERM', onClick: () => update('stopSignal', 'SIGTERM') },
                    { label: 'SIGINT', onClick: () => update('stopSignal', 'SIGINT') },
                    { label: 'SIGKILL', onClick: () => update('stopSignal', 'SIGKILL') },
                  ]}
                />
              </div>
      ...
      <div className="fixed inset-0 z-[9999] flex justify-end">
        ...
        `}>
          ...
          <div className="shrink-0 flex items-center justify-between px-6 py-4 border-b border-neutral-700/40">
            <h2 className="text-base font-semibold text-neutral-100 tracking-tight">Import Package</h2>
            <button
              onClick={triggerClose}
              className="shrink-0 inline-flex h-7 w-7 items-center justify-center rounded-lg text-neutral-500 hover:text-neutral-200 hover:bg-neutral-700/50 transition-all duration-150 cursor-pointer"
              aria-label="Close"
            >
