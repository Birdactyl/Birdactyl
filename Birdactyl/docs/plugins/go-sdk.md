...
Add custom pages, tabs, and topbar items to the panel. See [UI](ui.md) for the full guide.
...
| `NavItem(id, label, href, section)` | Add a topbar item |
...
| Constant | Description |
|----------|-------------|
| `NavSectionNav` | Main navigation |
| `NavSectionPlatform` | Platform section |
| `NavSectionAdmin` | Admin section |
